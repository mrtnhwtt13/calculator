...
Button(window, text="Close", command=window.destroy).grid(row=0, column=3)
...
Button(window, text=" * ", command=lambda: input_key("*")).grid(row=2, column=3)
Button(window, text=" / ", command=lambda: input_key("/")).grid(row=2, column=2)
